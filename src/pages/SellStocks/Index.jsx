...
import CardSell from "../../components/CardSell/Index";
...
function SellStocks() {
  ...
  if (!context.buyAccions || context.buyAccions.length === 0) {
    return <p className="text-center m-28 font-serif font-medium">No hay acciones disponibles para Vender.</p>;
  }


  return (
    <Layout>
      <label className="font-bold font-serif mt-6 text-orange-500 mb-2 ">Vender Acciones</label>
